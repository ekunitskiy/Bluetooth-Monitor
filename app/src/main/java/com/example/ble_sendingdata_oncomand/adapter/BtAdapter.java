package com.example.ble_sendingdata_oncomand.adapter;
...
import com.example.ble_sendingdata_oncomand.R;

import java.util.ArrayList;
import java.util.List;

public class BtAdapter extends ArrayAdapter<ListItem> {
    public final static String  DEF_ITEM_TYPE = "normal";
    public final static String  TITLE_ITEM_TYPE = "title";
    public final static String  DISCOVERY_ITEM_TYPE = "discovery";
    ...
    private View defaultItem(View convertView, int position, ViewGroup parent) {
        ...
        if(convertView == null || !hasViewHolder) {
            ...
            viewHolder.chBtSelected = convertView.findViewById(R.id.checkLine);
